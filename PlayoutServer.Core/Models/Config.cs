namespace PlayoutServer.Core.Models
{
    ...
    public class AppConfig
    {
        ...
        public int DefaultFrameRate { get; set; } = 25;        public bool UseLocalMediaScanner { get; set; } = false;        public string MediaFolderPath { get; set; } = @"C:\CasparCG\media"; // (DE) Pfad zum CasparCG Media-Ordner / (EN) Path to CasparCG media folder
    }
}
